...
<!DOCTYPE html>
	<head>
        ...
        <script type="text/javascript" src="./validateRegistrationForm.js"></script>
	...
	<body style="background-color:#FADFC5">
		...
		<div class="container" style="background-color: #FFFFFF; -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;">
        		<div class="span1">
                	<form id="registerForm" action="./registercheck.php" onsubmit="return validateRegistrationForm()" method="post">
    					<p><font color="red">*</font>Username: <input type="text" name="uName" /></p>
        				<p><font color="red">*</font>Password: <input type="password" name="uPassword" /></p>
                        <p><font color="red">*</font>Retype Password: <input type="password" name="uPasswordC" /></p>
                        <p><font color="red">*</font>Email: <input type="email" name="uEmail" /></p>
                        <p><font color="red">*</font>Retype Email: <input type="email" name="uEmailC" /></p>
